...
import examples.heredity.u6.m1.example4.ClassProtectedContaind;
...
public class DemoClassDerivadaProtected extends ClassProtectedContaind{
	...
	public static void main(String[] args) {
		...
		//Campo no visible al estar ser protected
		//System.out.println("varProtected: "+cDer.objClasProtected.varProtected);
		System.out.println("varProtected: "+cDer.objClasProtected.toString());
