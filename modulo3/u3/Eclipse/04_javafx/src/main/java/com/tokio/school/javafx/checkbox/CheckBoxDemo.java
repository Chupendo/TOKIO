...
public class CheckBoxDemo extends Application {
	...
	public void showAll() {
		...
		if(cbSmartphone.isSelected()) computers.append(getMsg("Smartphone"));
		if(cbTablet.isSelected()) computers.append(getMsg("Tablet"));
		if(cbNotebook.isSelected()) computers.append(getMsg("Notebook"));
		if(cbDesktop.isSelected()) computers.append(getMsg("Desktop"));
