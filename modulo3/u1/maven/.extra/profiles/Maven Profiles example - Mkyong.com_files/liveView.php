...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=107163&cbuster=1687464627&pubUrl=https://mkyong.com/maven/maven-profiles-example/&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,813,1&cbuster=1687466046',
					origQString: 's=107163&cbuster=1687464627&pubUrl=https://mkyong.com/maven/maven-profiles-example/&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,813,1',
					placementId: 107163,
					x: 400,
					y: 272,
					videoType: 'sticky',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"114.0","browserVersionMajor":"114","browserVersionMinor":"0","chromeVersion":""},"browser":"firefox","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"es","2":"en"},"googlePSI":false},
					isFpCookie: 1,
					geo: 'ES',
					dmaCode: 0,
					dynamicSetup: [],
